...
class Hamburger {
     ...
     * @param {Array} toppings - Дополнение
     */
     ...
     */
    addTopping(topping) {if (!this.toppings.includes(topping)){
     ...
     * @param {String} topping - Тип добавки
     */
    removeTopping(topping) {this.toppings.forEach(elem => this.toppings.splice(this.toppings.indexOf(topping), 1))}
     ...
     */
    calculatePrice() { let sum = 0;
        sum = 
         Hamburger.SIZES[this.size].price +
         Hamburger.STUFFINGS[this.stuffing].price +
         Hamburger.TOPPINGS[this.toppings.reduce((acc, val) => val)].price;
  ...
  */
  ...
  console.log(`Порверка на создание нового екземпляра`, hamburger);

  // Добавка из приправы
  hamburger.addTopping(Hamburger.TOPPING_SPICE);
  console.log(`Порверка на приправу`, hamburger);
